...
class sway_left(object):
    def __init__(self):
        self.rc_publisher = rospy.Publisher('/mavros/rc/override', OverrideRCIn,
                                            queue_size=10)
        self.service_server_object = rospy.Service('/autonomous/sway_left', Empty, self.service_callback)
        ...
        rospy.loginfo("The sway_left service is ready ")
