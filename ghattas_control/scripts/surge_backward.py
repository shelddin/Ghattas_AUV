...
class surge_backward(object):
    def __init__(self):
        self.rc_publisher = rospy.Publisher('/mavros/rc/override', OverrideRCIn,
                                            queue_size=10)
        self.service_server_object = rospy.Service('/autonomous/surge_backward', Empty, self.service_callback)
        ...
        rospy.loginfo("The surge_backward service is ready ")
