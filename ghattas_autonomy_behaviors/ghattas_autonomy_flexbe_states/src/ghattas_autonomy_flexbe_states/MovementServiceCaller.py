...
class MovementServiceCaller(EventState):
	'''
	...
	def __init__(self, target, service_name, srv_type):
		...
		types = {"dist": dist, "depth": depth, "hdg": hdg, "Empty" : Empty}
	...
	def execute(self, userdata):
		...
		if self._srv_type == Empty:
			Logger.loginfo("Executing The service %s"%self._topic,)
			self.service_client.call(self._topic,EmptyRequest())
